  ...
  return (
    <div className={styles.pets_container}>
      <div className={styles.title}>
        {
          <FormattedMessage id="page.registration.step.addYourPetsStep.yourPets" />
        }
      </div>
      <div className={styles.pets_list_container} ref={listRef}>
        {pets.map((pet) => {
          const showIcon =
            isSubmited ||
            (pet.dogName && pet.dogWeight && pet.breed && pet.dogBirthday);
      ...
      <div aria-hidden onClick={onAdd} className={styles.add_pet}>
        ...
        <FormattedMessage id="page.registration.step.addYourPetsStep.addAnotherPet" />
      </div>
    </div>
  );
};
